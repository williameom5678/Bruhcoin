...
uint256 hashGenesisBlock("0x93250fe46f30154112c72049eaee373b3b933b896d15fb354bf9062e014aef61");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 1000000); // Bruhcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 2 * 24 * 60 * 60; // Bruhcoin: 2 days
static const int64 nTargetSpacing = 2 * 60; // Bruhcoin: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        pchMessageStart[0] = 0x223;
        pchMessageStart[1] = 0x224;
        pchMessageStart[2] = 0x225;
        pchMessageStart[3] = 0x226;
        hashGenesisBlock = uint256("0xadb8882764abd4e83e9c71a1413d55c778d9254be96d46a18254cf4d7e21f7a3");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "First BruhCoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 100 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04fe2ab946ffeb366e42b777237328cd7223f8a1dd1823fc656dc6b5f79f35f29cf8853a3b5e1bc5bdbb69eb4dcb2fb8c974f8203a546c4577b075e4349719e66b") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1653798841;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085592773;

        if (fTestNet)
        {
            block.nTime    = 1653804098;
            block.nNonce   = 385950411;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x8aee39cd8ff7b48f750ba2900406cfe8a68384b1525372d4bc330a4e2a1aa2d1"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0x227, 0x228, 0x229, 0x230 }; // Bruhcoin: increase each by adding 2 to bitcoin's value.
